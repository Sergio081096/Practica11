...
float posX =0, posY = 2.5, posZ =-3.5, rotRodIzq = 0, rotRodDer = 0,girobrazoIzq,girobrazoDer;//por cada una debemos creae dos mas
float giroMonito = 0;
float angCodo=0.0f;
float angMano=0.0f;
...
#define MAX_FRAMES 80//cantidad de animaciones
int i_max_steps = 90;
int i_curr_steps = 0;//velocidad
...
int FrameIndex=5.0;			//introducir datos
bool play=false;
int playIndex=0;
...
void saveFrame ( void )
{
	...
	KeyFrame[0].girobrazoIzq=0.0;
	KeyFrame[0].girobrazoDer=0.0;
	KeyFrame[0].rotRodDer=0.0;

	KeyFrame[0].angCodo=0.0;
	KeyFrame[0].angMano=0.0;
	KeyFrame[0].angPulgar1=0.0;
	KeyFrame[0].angPulgar2=0.0;
	KeyFrame[0].angDedo21=0.0;
	KeyFrame[0].angDedo22=0.0;
	KeyFrame[0].angDedo23=0.0;
	KeyFrame[0].angDedo31=0.0;
	KeyFrame[0].angDedo32=0.0;
	KeyFrame[0].angDedo33=0.0;
	KeyFrame[0].angDedo41=0.0;
	KeyFrame[0].angDedo42=0.0;
	KeyFrame[0].angDedo43=0.0;
	KeyFrame[0].angDedo51=0.0;
	KeyFrame[0].angDedo52=0.0;
	KeyFrame[0].angDedo53=0.0;
	...
	KeyFrame[1].girobrazoIzq=0.0;
	KeyFrame[1].girobrazoDer=0.0;
	KeyFrame[1].rotRodDer=0.0;

	KeyFrame[1].angCodo=0.0;
	KeyFrame[1].angMano=0.0;
	KeyFrame[1].angPulgar1=-70;
	KeyFrame[1].angPulgar2=-50;
	KeyFrame[1].angDedo21=-60;
	KeyFrame[1].angDedo22=-90;
	KeyFrame[1].angDedo23=-85;
	KeyFrame[1].angDedo31=-85;
	KeyFrame[1].angDedo32=-90;
	KeyFrame[1].angDedo33=-85;
	KeyFrame[1].angDedo41=-85;
	KeyFrame[1].angDedo42=-90;
	KeyFrame[1].angDedo43=-85;
	KeyFrame[1].angDedo51=-85;
	KeyFrame[1].angDedo52=-90;
	KeyFrame[1].angDedo53=-70;
	...
	KeyFrame[2].girobrazoIzq=0.0;
	KeyFrame[2].girobrazoDer=0.0;
	KeyFrame[2].rotRodDer=0.0;

	KeyFrame[2].angCodo=0.0;
	KeyFrame[2].angMano=0.0;
	KeyFrame[2].angPulgar1=0.0;
	KeyFrame[2].angPulgar2=0.0;
	KeyFrame[2].angDedo21=0.0;
	KeyFrame[2].angDedo22=0.0;
	KeyFrame[2].angDedo23=0.0;
	KeyFrame[2].angDedo31=0.0;
	KeyFrame[2].angDedo32=0.0;
	KeyFrame[2].angDedo33=0.0;
	KeyFrame[2].angDedo41=0.0;
	KeyFrame[2].angDedo42=0.0;
	KeyFrame[2].angDedo43=0.0;
	KeyFrame[2].angDedo51=0.0;
	KeyFrame[2].angDedo52=0.0;
	KeyFrame[2].angDedo53=0.0;
	...
	KeyFrame[3].girobrazoIzq=0.0;
	KeyFrame[3].girobrazoDer=0.0;
	KeyFrame[3].rotRodDer=0.0;

	KeyFrame[3].angCodo=0.0;
	KeyFrame[3].angMano=0.0;
	KeyFrame[3].angPulgar1=-70;
	KeyFrame[3].angPulgar2=-50;
	KeyFrame[3].angDedo21=0.0;
	KeyFrame[3].angDedo22=0.0;
	KeyFrame[3].angDedo23=0.0;
	KeyFrame[3].angDedo31=0.0;
	KeyFrame[3].angDedo32=0.0;
	KeyFrame[3].angDedo33=0.0;
	KeyFrame[3].angDedo41=-85;
	KeyFrame[3].angDedo42=-90;
	KeyFrame[3].angDedo43=-85;
	KeyFrame[3].angDedo51=-85;
	KeyFrame[3].angDedo52=-90;
	KeyFrame[3].angDedo53=-70;
	...
	KeyFrame[4].girobrazoIzq=0.0;
	KeyFrame[4].girobrazoDer=0.0;
	KeyFrame[4].rotRodDer=0.0;

	KeyFrame[4].angCodo=0.0;
	KeyFrame[4].angMano=0.0;
	KeyFrame[4].angPulgar1=0.0;
	KeyFrame[4].angPulgar2=0.0;
	KeyFrame[4].angDedo21=-60;
	KeyFrame[4].angDedo22=-90;
	KeyFrame[4].angDedo23=-85;
	KeyFrame[4].angDedo31=-85;
	KeyFrame[4].angDedo32=-90;
	KeyFrame[4].angDedo33=-85;
	KeyFrame[4].angDedo41=-85;
	KeyFrame[4].angDedo42=-90;
	KeyFrame[4].angDedo43=-85;
	KeyFrame[4].angDedo51=-85;
	KeyFrame[4].angDedo52=-90;
	KeyFrame[4].angDedo53=-70;
	

	printf("frameindex %d\n",FrameIndex);//frameindex es contador
	...
	KeyFrame[FrameIndex].angDedo21=angDedo21;
	KeyFrame[FrameIndex].angDedo22=angDedo22;
	KeyFrame[FrameIndex].angDedo23=angDedo23;
	KeyFrame[FrameIndex].angDedo31=angDedo31;
	KeyFrame[FrameIndex].angDedo32=angDedo32;
	KeyFrame[FrameIndex].angDedo33=angDedo33;
	KeyFrame[FrameIndex].angDedo41=angDedo41;
	KeyFrame[FrameIndex].angDedo42=angDedo42;
	KeyFrame[FrameIndex].angDedo43=angDedo43;
	KeyFrame[FrameIndex].angDedo51=angDedo51;
	KeyFrame[FrameIndex].angDedo52=angDedo52;
	KeyFrame[FrameIndex].angDedo53=angDedo53;
			
	FrameIndex++;
}

void resetElements( void )//posiciones guardadas
{
	...
	angDedo21=KeyFrame[0].angDedo21;
	angDedo22=KeyFrame[0].angDedo22;
	angDedo23=KeyFrame[0].angDedo23;
	angDedo31=KeyFrame[0].angDedo31;
	angDedo32=KeyFrame[0].angDedo32;
	angDedo33=KeyFrame[0].angDedo33;
	angDedo41=KeyFrame[0].angDedo41;
	angDedo42=KeyFrame[0].angDedo42;
	angDedo43=KeyFrame[0].angDedo43;
	angDedo51=KeyFrame[0].angDedo51;
	angDedo52=KeyFrame[0].angDedo52;
	angDedo53=KeyFrame[0].angDedo53;
...
void interpolation ( void )
{
	...
	KeyFrame[playIndex].angDedo21Inc = (KeyFrame[playIndex + 1].angDedo21 - KeyFrame[playIndex].angDedo21) / i_max_steps;
	KeyFrame[playIndex].angDedo22Inc = (KeyFrame[playIndex + 1].angDedo22 - KeyFrame[playIndex].angDedo22) / i_max_steps;
	KeyFrame[playIndex].angDedo23Inc = (KeyFrame[playIndex + 1].angDedo23 - KeyFrame[playIndex].angDedo23) / i_max_steps;
	KeyFrame[playIndex].angDedo31Inc = (KeyFrame[playIndex + 1].angDedo31 - KeyFrame[playIndex].angDedo31) / i_max_steps;
	KeyFrame[playIndex].angDedo32Inc = (KeyFrame[playIndex + 1].angDedo32 - KeyFrame[playIndex].angDedo32) / i_max_steps;
	KeyFrame[playIndex].angDedo33Inc = (KeyFrame[playIndex + 1].angDedo33 - KeyFrame[playIndex].angDedo33) / i_max_steps;
	KeyFrame[playIndex].angDedo41Inc = (KeyFrame[playIndex + 1].angDedo41 - KeyFrame[playIndex].angDedo41) / i_max_steps;
	KeyFrame[playIndex].angDedo42Inc = (KeyFrame[playIndex + 1].angDedo42 - KeyFrame[playIndex].angDedo42) / i_max_steps;
	KeyFrame[playIndex].angDedo43Inc = (KeyFrame[playIndex + 1].angDedo43 - KeyFrame[playIndex].angDedo43) / i_max_steps;
	KeyFrame[playIndex].angDedo51Inc = (KeyFrame[playIndex + 1].angDedo51 - KeyFrame[playIndex].angDedo51) / i_max_steps;
	KeyFrame[playIndex].angDedo52Inc = (KeyFrame[playIndex + 1].angDedo52 - KeyFrame[playIndex].angDedo52) / i_max_steps;
	KeyFrame[playIndex].angDedo53Inc = (KeyFrame[playIndex + 1].angDedo53 - KeyFrame[playIndex].angDedo53) / i_max_steps;
...
void mano()
{
	...
	//hombro
		...
		if((angCodo>=0.0)&&(angCodo<=120.0))
			glRotatef(0+angCodo,0.0,0.0,1.0);//Uu--Ii
		else if(angCodo<0.0)
			{
		...
		glPushMatrix();		
			...
			//3
			glTranslatef(0.0,-0.075,0.0);
			if((0+angDedo53>=-85.0)&&(angDedo53<=0.0))
	...
	glPushMatrix();//Pecho
		...
		glPushMatrix(); //Brazo derecho-->
			...
			glPushMatrix();
				...
				glRotatef(-75, 0.0, 1.0, 0);
				if((girobrazoDer>=-20.0)&&(girobrazoDer<=180.0))
					glRotatef(64+girobrazoDer,0.0,0.0,1.0);//Tt--Yy
				else if(girobrazoDer<-20.0)
					{
					glRotatef(-20.0,0.0,0.0,1.0);
					girobrazoDer=-20.0;
					}
				else if(girobrazoDer>180.0)
					{
		...
		glColor3f(1.0,1.0,1.0);
			...
			glPushMatrix();
				...
				glRotatef(45, 0, 1, 0); 
				glRotatef(25+girobrazoIzq, 0, 0, 1);
				glRotatef(25, 1, 0, 0); 
...
void InitGL ( GLvoid )     // Inicializamos parametros
{
	...
	/*for(int i=0; i<MAX_FRAMES; i++)
	{
		...
		KeyFrame[i].angCodo=0.0;
		KeyFrame[i].angMano=0.0;
		KeyFrame[i].angPulgar1=0.0;
		KeyFrame[i].angPulgar2=0.0;
		KeyFrame[i].angDedo21=0.0;
		KeyFrame[i].angDedo22=0.0;
		KeyFrame[i].angDedo23=0.0;
		KeyFrame[i].angDedo31=0.0;
		KeyFrame[i].angDedo32=0.0;
		KeyFrame[i].angDedo33=0.0;
		KeyFrame[i].angDedo41=0.0;
		KeyFrame[i].angDedo42=0.0;
		KeyFrame[i].angDedo43=0.0;
		KeyFrame[i].angDedo51=0.0;
		KeyFrame[i].angDedo52=0.0;
		KeyFrame[i].angDedo53=0.0;
		...
		glPushMatrix();		
			...
			glPushMatrix();
				...
				glPushMatrix();
					...
					glPushMatrix();
						glRotatef(90, 0,1,0);
						dibujaLaptop(0.3,0.3,0.3,-90.0,9.0,77.0);
					glPopMatrix();
...
void animacion()
{
	...
	{		
		...
		else
		{
			...
			girobrazoIzq+=KeyFrame[playIndex].girobrazoIzqInc;
			girobrazoDer+=KeyFrame[playIndex].girobrazoDerInc;
			...
			angDedo21+=KeyFrame[playIndex].angDedo21Inc;
			angDedo22+=KeyFrame[playIndex].angDedo22Inc;
			angDedo23+=KeyFrame[playIndex].angDedo23Inc;
			angDedo31+=KeyFrame[playIndex].angDedo31Inc;
			angDedo32+=KeyFrame[playIndex].angDedo32Inc;
			angDedo33+=KeyFrame[playIndex].angDedo33Inc;
			angDedo41+=KeyFrame[playIndex].angDedo41Inc;
			angDedo42+=KeyFrame[playIndex].angDedo42Inc;
			angDedo43+=KeyFrame[playIndex].angDedo43Inc;
			angDedo51+=KeyFrame[playIndex].angDedo51Inc;
			angDedo52+=KeyFrame[playIndex].angDedo52Inc;
			angDedo53+=KeyFrame[playIndex].angDedo53Inc;
...
void keyboard ( unsigned char key, int x, int y )  // Create Keyboard Function
{
	switch ( key ) {
		...
		case 'o':		//
		case 'O':
			if(FrameIndex<MAX_FRAMES)//contador menor a la cantidad maxima
			{
		...
		case 'g':
			angDedo22 -=0.7f;
			printf("Posicion en 22: %f\n", angDedo22);
			break;
		case 'T':
			angDedo21 +=0.7f;
			//printf("Posicion en 21: %f\n", angDedo21);
			break;
		case 't':
			angDedo21 -=0.7f;
			printf("Posicion en 31: %f\n", angDedo21);
